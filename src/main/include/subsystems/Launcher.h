...
namespace ConLauncher {
  ...
  constexpr int BERT_FWD_LIMIT = 140;
  constexpr int ERNIE_FWD_LIMIT = 155;
  constexpr int BERT_REV_LIMIT = 0;
  constexpr int ERNIE_REV_LIMIT = 0;
  constexpr int BERT_FAR_LIMIT = 185;
  constexpr int ERNIE_FAR_LIMIT = 185;
  constexpr double BERT_RAMP_RATE = .1;
  constexpr double ERNIE_RAMP_RATE = .1;
  constexpr double BERT_POWER = .77;
  constexpr double ERNIE_POWER = .73;
  constexpr double BERT_FAR_POWER = .76;
  constexpr double ERNIE_FAR_POWER = .76;
